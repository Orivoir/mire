 ...
 */
final class Version20200309075135 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT NOT NULL, user_id INT NOT NULL, title VARCHAR(255) NOT NULL, content TEXT NOT NULL, create_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, is_public BOOLEAN NOT NULL, is_remove BOOLEAN NOT NULL, remove_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, is_warning_public BOOLEAN NOT NULL, background_name VARCHAR(255) DEFAULT NULL, opacity DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
